...
% 'offspring' is the population of offspring generated by genetic operations [t*2+1 x n+4 x n_individuals]
...
%
% OUTPUT: 
% 'nextGenPop' is the population of the next generation [t*2+1 x n+4 x n_individuals]
